...
import { evmAddress, hexString, ResultAwareError, err, ok, never as never$1, okAsync, ResultAsync, errAsync, signatureFrom, uuid, invariant as invariant$1 } from '@lens-protocol/types';
import { validate, visit, Kind } from 'graphql';
  ...
  "../../node_modules/.pnpm/json-stable-stringify@1.1.1/node_modules/json-stable-stringify/index.js"(exports, module) {
    ...
    module.exports = function stableStringify(obj) {
      ...
      var cmp = cmpOpt && function(node) {
        var get2 = cmpOpt.length > 2 && function get3(k2) {
          return node[k2];
        };
...
function Nt(e) {
  let t = e.unionErrors.map((x2) => x2.issues.map((y2) => oe(y2.path) ? `"${Ue(y2.path)}": ${y2.message}` : y2.message)), r = [...new Set(t.map((x2) => x2.join("; ")))], o = Array.isArray(e.path) ? e.path : [e.path], S = oe(o) ? `"${Ue(o)}": ` : "";
...
var H = z.string().describe("A Geographic coordinate as subset of Geo URI (RFC 5870). Currently only supports the `geo:lat,lng` format.").regex(Fe, "Should be a Geo URI. Expected `geo:lat,lng`.").superRefine((e, t) => {
  let r = Fe.exec(e);
  if (!r) return z.NEVER;
  let [, o = "", S = ""] = r, x2 = tt.safeParse(o);
  if (!x2.success) for (let ve of x2.error.issues) t.addIssue({ ...ve, path: [...t.path, "lat"] });
  let y2 = at.safeParse(S);
  if (!y2.success) for (let ve of y2.error.issues) t.addIssue({ ...ve, path: [...t.path, "lng"] });
  return z.NEVER;
});
...
var qt = ((x2) => (x2.BOOLEAN = "Boolean", x2.DATE = "Date", x2.NUMBER = "Number", x2.STRING = "String", x2.JSON = "JSON", x2))(qt || {});
...
var gt = ((m3) => (m3.CCO = "CCO", m3.CC_BY = "CC BY", m3.CC_BY_ND = "CC BY-ND", m3.CC_BY_NC = "CC BY-NC", m3.TBNL_C_D_PL_Legal = "TBNL-C-D-PL-Legal", m3.TBNL_C_DT_PL_Legal = "TBNL-C-DT-PL-Legal", m3.TBNL_C_ND_PL_Legal = "TBNL-C-ND-PL-Legal", m3.TBNL_C_D_NPL_Legal = "TBNL-C-D-NPL-Legal", m3.TBNL_C_DT_NPL_Legal = "TBNL-C-DT-NPL-Legal", m3.TBNL_C_DTSA_PL_Legal = "TBNL-C-DTSA-PL-Legal", m3.TBNL_C_DTSA_NPL_Legal = "TBNL-C-DTSA-NPL-Legal", m3.TBNL_C_ND_NPL_Legal = "TBNL-C-ND-NPL-Legal", m3.TBNL_C_D_PL_Ledger = "TBNL-C-D-PL-Ledger", m3.TBNL_C_DT_PL_Ledger = "TBNL-C-DT-PL-Ledger", m3.TBNL_C_ND_PL_Ledger = "TBNL-C-ND-PL-Ledger", m3.TBNL_C_D_NPL_Ledger = "TBNL-C-D-NPL-Ledger", m3.TBNL_C_DT_NPL_Ledger = "TBNL-C-DT-NPL-Ledger", m3.TBNL_C_DTSA_PL_Ledger = "TBNL-C-DTSA-PL-Ledger", m3.TBNL_C_DTSA_NPL_Ledger = "TBNL-C-DTSA-NPL-Ledger", m3.TBNL_C_ND_NPL_Ledger = "TBNL-C-ND-NPL-Ledger", m3.TBNL_NC_D_PL_Legal = "TBNL-NC-D-PL-Legal", m3.TBNL_NC_DT_PL_Legal = "TBNL-NC-DT-PL-Legal", m3.TBNL_NC_ND_PL_Legal = "TBNL-NC-ND-PL-Legal", m3.TBNL_NC_D_NPL_Legal = "TBNL-NC-D-NPL-Legal", m3.TBNL_NC_DT_NPL_Legal = "TBNL-NC-DT-NPL-Legal", m3.TBNL_NC_DTSA_PL_Legal = "TBNL-NC-DTSA-PL-Legal", m3.TBNL_NC_DTSA_NPL_Legal = "TBNL-NC-DTSA-NPL-Legal", m3.TBNL_NC_ND_NPL_Legal = "TBNL-NC-ND-NPL-Legal", m3.TBNL_NC_D_PL_Ledger = "TBNL-NC-D-PL-Ledger", m3.TBNL_NC_DT_PL_Ledger = "TBNL-NC-DT-PL-Ledger", m3.TBNL_NC_ND_PL_Ledger = "TBNL-NC-ND-PL-Ledger", m3.TBNL_NC_D_NPL_Ledger = "TBNL-NC-D-NPL-Ledger", m3.TBNL_NC_DT_NPL_Ledger = "TBNL-NC-DT-NPL-Ledger", m3.TBNL_NC_DTSA_PL_Ledger = "TBNL-NC-DTSA-PL-Ledger", m3.TBNL_NC_DTSA_NPL_Ledger = "TBNL-NC-DTSA-NPL-Ledger", m3.TBNL_NC_ND_NPL_Ledger = "TBNL-NC-ND-NPL-Ledger", m3))(gt || {});
...
var Tt = ((y2) => (y2.MUSIC = "MUSIC", y2.PODCAST = "PODCAST", y2.AUDIOBOOK = "AUDIOBOOK", y2.VOICE_NOTE = "VOICE_NOTE", y2.SOUND = "SOUND", y2.OTHER = "OTHER", y2))(Tt || {});
var $e = ((w2) => (w2.WAV = "audio/wav", w2.WAV_VND = "audio/vnd.wave", w2.MP3 = "audio/mpeg", w2.OGG_AUDIO = "audio/ogg", w2.MP4_AUDIO = "audio/mp4", w2.AAC = "audio/aac", w2.WEBM_AUDIO = "audio/webm", w2.FLAC = "audio/flac", w2))($e || {});
...
var Ke = ((C4) => (C4.GLTF = "model/gltf+json", C4.GLTF_BINARY = "model/gltf-binary", C4.M4V = "video/x-m4v", C4.MOV = "video/mov", C4.MP4 = "video/mp4", C4.MPEG = "video/mpeg", C4.OGG = "video/ogg", C4.OGV = "video/ogv", C4.QUICKTIME = "video/quicktime", C4.WEBM = "video/webm", C4))(Ke || {});
...
z.nativeEnum(He);
var E = `${g}/posts`;
var s = ((d2) => (d2[d2.THREE_D_LATEST = `${E}/3d/3.0.0.json`] = "THREE_D_LATEST", d2[d2.ARTICLE_LATEST = `${E}/article/3.0.0.json`] = "ARTICLE_LATEST", d2[d2.AUDIO_LATEST = `${E}/audio/3.0.0.json`] = "AUDIO_LATEST", d2[d2.CHECKING_IN_LATEST = `${E}/checking-in/3.0.0.json`] = "CHECKING_IN_LATEST", d2[d2.EMBED_LATEST = `${E}/embed/3.0.0.json`] = "EMBED_LATEST", d2[d2.EVENT_LATEST = `${E}/event/3.0.0.json`] = "EVENT_LATEST", d2[d2.IMAGE_LATEST = `${E}/image/3.0.0.json`] = "IMAGE_LATEST", d2[d2.LINK_LATEST = `${E}/link/3.0.0.json`] = "LINK_LATEST", d2[d2.LIVESTREAM_LATEST = `${E}/livestream/3.0.0.json`] = "LIVESTREAM_LATEST", d2[d2.MINT_LATEST = `${E}/mint/3.0.0.json`] = "MINT_LATEST", d2[d2.SPACE_LATEST = `${E}/space/3.0.0.json`] = "SPACE_LATEST", d2[d2.STORY_LATEST = `${E}/story/3.0.0.json`] = "STORY_LATEST", d2[d2.TRANSACTION_LATEST = `${E}/transaction/3.0.0.json`] = "TRANSACTION_LATEST", d2[d2.TEXT_ONLY_LATEST = `${E}/text-only/3.0.0.json`] = "TEXT_ONLY_LATEST", d2[d2.VIDEO_LATEST = `${E}/video/3.0.0.json`] = "VIDEO_LATEST", d2))(s || {});
...
var T = ((y2) => (y2[y2.FEED_LATEST = `${g}/rules/feed/1.0.0.json`] = "FEED_LATEST", y2[y2.GRAPH_LATEST = `${g}/rules/graph/1.0.0.json`] = "GRAPH_LATEST", y2[y2.GROUP_LATEST = `${g}/rules/group/1.0.0.json`] = "GROUP_LATEST", y2[y2.NAMESPACE_LATEST = `${g}/rules/namespace/1.0.0.json`] = "NAMESPACE_LATEST", y2[y2.POST_LATEST = `${g}/rules/post/1.0.0.json`] = "POST_LATEST", y2[y2.FOLLOW_LATEST = `${g}/rules/follow/1.0.0.json`] = "FOLLOW_LATEST", y2))(T || {});
...
function p2(n3 = false) {
  let e = C(n3), i2 = (r, t, c2, o) => {
    let l3 = "", s3 = 0;
    do
      l3 += r.substring(s3, o) + c2, s3 = o + t.length, o = r.indexOf(t, s3);
    while (~o);
    return l3 + r.substring(s3);
  }, g2 = (r, t, c2 = r) => {
    let o = (l3) => {
      let s3 = String(l3), b = s3.indexOf(t, r.length);
...
// ../../node_modules/.pnpm/@vitest+pretty-format@3.1.1/node_modules/@vitest/pretty-format/dist/index.js
...
function requireReactIs_production_min() {
  ...
  var b = Symbol.for("react.element"), c2 = Symbol.for("react.portal"), d2 = Symbol.for("react.fragment"), e = Symbol.for("react.strict_mode"), f5 = Symbol.for("react.profiler"), g2 = Symbol.for("react.provider"), h4 = Symbol.for("react.context"), k2 = Symbol.for("react.server_context"), l3 = Symbol.for("react.forward_ref"), m3 = Symbol.for("react.suspense"), n3 = Symbol.for("react.suspense_list"), p4 = Symbol.for("react.memo"), q = Symbol.for("react.lazy"), t = Symbol.for("react.offscreen"), u3;
  ...
  reactIs_production_min.isValidElementType = function(a4) {
    return "string" === typeof a4 || "function" === typeof a4 || a4 === d2 || a4 === f5 || a4 === e || a4 === m3 || a4 === n3 || a4 === t || "object" === typeof a4 && null !== a4 && (a4.$$typeof === q || a4.$$typeof === p4 || a4.$$typeof === g2 || a4.$$typeof === h4 || a4.$$typeof === l3 || a4.$$typeof === u3 || void 0 !== a4.getModuleId) ? true : false;
  };
...
// ../../node_modules/.pnpm/@vitest+utils@3.1.1/node_modules/@vitest/utils/dist/chunk-_commonjsHelpers.js
...
// ../../node_modules/.pnpm/@vitest+utils@3.1.1/node_modules/@vitest/utils/dist/helpers.js
...
// ../../node_modules/.pnpm/@vitest+utils@3.1.1/node_modules/@vitest/utils/dist/index.js
var jsTokens_1;
...
// ../../node_modules/.pnpm/@vitest+utils@3.1.1/node_modules/@vitest/utils/dist/diff.js
var DIFF_DELETE = -1;
var DIFF_INSERT = 1;
var DIFF_EQUAL = 0;
var Diff = class {
...
function f3(e, t, n3) {
  Object.defineProperty(e, t, n3);
}
function l2(e, t, n3) {
  Object.defineProperty(e, t, { value: n3 });
}
...
function m2(e) {
  ...
  let t = function(...s3) {
    let r = T2(t);
    r.called = true, r.callCount++, r.calls.push(s3);
    let S = r.next.shift();
    if (S) {
      r.results.push(S);
      let [o, g2] = S;
    ...
    let p4, c2 = "ok", a4 = r.results.length;
    if (r.impl)
      try {
        new.target ? p4 = Reflect.construct(r.impl, s3, new.target) : p4 = r.impl.apply(this, s3), c2 = "ok";
      } catch (o) {
        throw p4 = o, c2 = "error", r.results.push([c2, o]), o;
      }
    let R2 = [c2, p4];
    return w(p4) && p4.then(
      (o) => r.resolves[a4] = ["ok", o],
      (o) => r.resolves[a4] = ["error", o]
    ), r.results.push(R2), p4;
  };
  l2(t, "_isMockFunction", true), l2(t, "length", e ? e.length : 0), l2(t, "name", e && e.name || "spy");
  let n3 = T2(t);
  return n3.reset(), n3.impl = e, t;
}
...
function C2(e, t, n3) {
  ...
  })(), S = k(e, s3), p4 = Object.getPrototypeOf(e), c2 = p4 && k(p4, s3), a4 = S || c2;
  d(
    a4 || s3 in e,
    `${String(s3)} does not exist`
  );
  let R2 = false;
  r === "value" && a4 && !a4.value && a4.get && (r = "get", R2 = true, n3 = a4.get());
  let o;
  a4 ? o = a4[r] : r !== "value" ? o = () => e[s3] : o = e[s3];
  let g2 = (v) => {
    let { value: M2, ...h4 } = a4 || {
      configurable: true,
      writable: true
    };
    r !== "value" && delete h4.writable, h4[r] = v, f3(e, s3, h4);
  }, b = () => a4 ? f3(e, s3, a4) : g2(o);
  n3 || (n3 = o);
  let i2 = m2(n3);
  r === "value" && O(i2, o);
  let I = i2[u2];
  return l2(I, "restore", b), l2(I, "getOriginal", () => R2 ? o() : o), l2(I, "willCall", (v) => (I.impl = v, i2)), g2(
    R2 ? () => (O(i2, n3), i2) : i2
  ), x.add(i2), i2;
}

// ../../node_modules/.pnpm/@vitest+spy@3.1.1/node_modules/@vitest/spy/dist/index.js
...
// ../../node_modules/.pnpm/@vitest+utils@3.1.1/node_modules/@vitest/utils/dist/error.js
...
function processError(_err, diffOptions, seen = /* @__PURE__ */ new WeakSet()) {
  ...
  const err3 = _err;
  if (err3.stack) {
    err3.stackStr = String(err3.stack);
  }
  if (err3.name) {
    err3.nameStr = String(err3.name);
  }
  ...
  if (typeof err3.expected !== "string") {
    err3.expected = stringify(err3.expected, 10);
  }
  if (typeof err3.actual !== "string") {
...
assert.operator = function(val, operator, val2, msg) {
  ...
  var test22 = new Assertion(ok4, msg, assert.operator, true);
  test22.assert(
...
// ../../node_modules/.pnpm/@vitest+expect@3.1.1/node_modules/@vitest/expect/dist/index.js
...
// ../../node_modules/.pnpm/@vitest+runner@3.1.1/node_modules/@vitest/runner/dist/chunk-tasks.js
...
// ../../node_modules/.pnpm/@vitest+runner@3.1.1/node_modules/@vitest/runner/dist/index.js
...
// ../../node_modules/.pnpm/vitest@3.1.1_@types+node@22.10.2_happy-dom@15.11.7_msw@2.7.0_@types+node@22.10.2_typescript@5.7.2__tsx@4.19.3/node_modules/vitest/dist/chunks/utils.CtocqOoE.js
...
// ../../node_modules/.pnpm/vitest@3.1.1_@types+node@22.10.2_happy-dom@15.11.7_msw@2.7.0_@types+node@22.10.2_typescript@5.7.2__tsx@4.19.3/node_modules/vitest/dist/chunks/_commonjsHelpers.BFTU3MAI.js
var commonjsGlobal = typeof globalThis !== "undefined" ? globalThis : typeof window !== "undefined" ? window : typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : {};
function getDefaultExportFromCjs3(x2) {
  return x2 && x2.__esModule && Object.prototype.hasOwnProperty.call(x2, "default") ? x2["default"] : x2;
}

// ../../node_modules/.pnpm/@vitest+snapshot@3.1.1/node_modules/@vitest/snapshot/dist/index.js
...
a3.open = "";
a3.close = "";
function C3(n3 = false) {
  let e = typeof process != "undefined" ? process : void 0, i2 = (e == null ? void 0 : e.env) || {}, g2 = (e == null ? void 0 : e.argv) || [];
  return !("NO_COLOR" in i2 || g2.includes("--no-color")) && ("FORCE_COLOR" in i2 || g2.includes("--color") || (e == null ? void 0 : e.platform) === "win32" || n3 && i2.TERM !== "dumb" || "CI" in i2) || typeof window != "undefined" && !!window.chrome;
}
function p3(n3 = false) {
  let e = C3(n3), i2 = (r, t, c2, o) => {
    let l3 = "", s3 = 0;
    do
      l3 += r.substring(s3, o) + c2, s3 = o + t.length, o = r.indexOf(t, s3);
    while (~o);
...
// ../../node_modules/.pnpm/vitest@3.1.1_@types+node@22.10.2_happy-dom@15.11.7_msw@2.7.0_@types+node@22.10.2_typescript@5.7.2__tsx@4.19.3/node_modules/vitest/dist/chunks/date.CDOsz-HY.js
var RealDate = Date;
var now2 = null;
var MockDate = class _MockDate extends RealDate {
  constructor(y2, m3, d2, h4, M2, s3, ms) {
    super();
    let date;
    switch (arguments.length) {
      ...
      default:
        ...
        s3 = s3 || 0;
        ms = ms || 0;
        date = new RealDate(y2, m3, d2, h4, M2, s3, ms);
        break;
    }
...
// ../../node_modules/.pnpm/vitest@3.1.1_@types+node@22.10.2_happy-dom@15.11.7_msw@2.7.0_@types+node@22.10.2_typescript@5.7.2__tsx@4.19.3/node_modules/vitest/dist/chunks/vi.B-PuvDzu.js
var unsupported = [
  "matchSnapshot",
  "toMatchSnapshot",
...
To automatically clean-up native timers, use \`shouldClearNativeTimers\`.`
    ...
    function uninstall(clock, config2) {
      ...
      for (i2 = 0, l3 = clock.methods.length; i2 < l3; i2++) {
...
// ../../node_modules/.pnpm/vitest@3.1.1_@types+node@22.10.2_happy-dom@15.11.7_msw@2.7.0_@types+node@22.10.2_typescript@5.7.2__tsx@4.19.3/node_modules/vitest/dist/index.js
...
var Logger = class _Logger {
  ...
  // alias for debug
  replaceMethods() {
    ["trace", "debug", "info", "warn", "error"].forEach((methodName, index2) => {
...
var SessionClient = class _SessionClient extends AbstractClient {
  ...
  logout() {
    return this.getAuthenticatedUser().asyncAndThen(({ authenticationId }) => revokeAuthentication(this, { authenticationId })).andTee(
      () => ResultAsync.fromPromise(this.storage.reset(), (err3) => UnexpectedError.from(err3))
    );
  }
  /**
   * {@inheritDoc AbstractClient.isPublicClient}
  ...
  waitForTransaction = (txHash) => {
    return ResultAsync.fromPromise(this.pollTransactionStatus(txHash), (err3) => {
...
var GLOBAL_SPONSORSHIP = evmAddress(import.meta.env.GLOBAL_SPONSORSHIP);
